    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_number', models.CharField(blank=True, max_length=25, null=True, verbose_name='Batch Number')),
                ('rack', models.CharField(blank=True, max_length=25, null=True, verbose_name='Rack')),
                ('row', models.CharField(blank=True, max_length=25, null=True, verbose_name='Row')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slab', models.CharField(blank=True, max_length=25, null=True, verbose_name='Slab')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted By')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ManyToManyField(related_name='variants', to='inventory.batch', verbose_name='Variants')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted By')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
                ('variants', models.ManyToManyField(related_name='inventoryvariants', to='product.variant', verbose_name='Variants')),
            ],
            options={
                'ordering': ['-updated_at'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='batch',
            name='tax',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax', to='inventory.tax', verbose_name='Tax'),
        ),
        migrations.AddField(
            model_name='batch',
            name='updated_by',
