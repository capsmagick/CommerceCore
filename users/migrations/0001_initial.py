    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.CharField(blank=True, max_length=20, null=True, verbose_name='Customer ID')),
                ('mobile_number', models.CharField(max_length=15, null=True, verbose_name='Mobile Number')),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='Date Of Birth')),
                ('gender', models.CharField(blank=True, choices=[('Men', 'Men'), ('Women', 'Women'), ('Prefer Not to say', 'Prefer Not to say')], max_length=25, null=True, verbose_name='Gender')),
                ('profile_picture', models.FileField(blank=True, null=True, upload_to='profile/', verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_line_1', models.CharField(blank=True, max_length=256, null=True, verbose_name='House Address')),
                ('address_line_2', models.CharField(blank=True, max_length=256, null=True, verbose_name='Area Address')),
                ('land_mark', models.CharField(blank=True, max_length=256, null=True, verbose_name='Landmark')),
                ...
                ('address_type', models.CharField(blank=True, choices=[('Billing', 'Billing'), ('Shipping', 'Shipping')], max_length=10, null=True, verbose_name='Address Type')),
                ('is_default', models.BooleanField(default=False)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted By')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='useraddress', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-updated_at'],
                'abstract': False,
